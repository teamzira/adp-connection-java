 ...
 *
 */
public class ClientCredentialsConnection implements ADPAPIConnection {
	
	private static final Logger LOGGER = Logger.getLogger(ClientCredentialsConnection.class.getName());
	 ...
	 * constructor
	 */
	private ClientCredentialsConnection() {
		super();
		connectionConfiguration = new ClientCredentialsConfiguration();
	}
	
	/**
	 * constructor  sets configuration to this connection
	 */
	public ClientCredentialsConnection(ConnectionConfiguration connectionConfiguration) {
		super();
	 ...
	 * 
	 * @throws ConnectionException exception thrown when validation fails on 
	 ...
	 * to this connection
	 * 
	 * @param connectionConfiguration maps ClientCredentialsCodeConfiguration to 
